...
from src.database.models import ApiKey, Job, Session
from src.database.repositories.job_repository import JobRepository
from src.shared.normalize import normalized_input_fingerprint


@pytest.mark.asyncio
async def test_job_lookup_enforces_session_and_tenant_boundaries(
        ...
        db.add_all(
            [
                ...
                Job(
                    ...
                    normalized_input_hash=normalized_input_fingerprint(normalized_input),
                    result={"owner": "a"},
                    created_at=now,
                ),
                Job(
