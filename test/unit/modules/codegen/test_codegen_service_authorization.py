    ...
    enriched_preferred_authorizations = [
        {
            ...
            "type": "bearer",
            "quirks": "Use Authorization header.",
            ANALYSIS_SUPPORT_FIELD: ANALYSIS_SUPPORT_SUPPORTED,
        }
    ]
    relevant_map = {
        "authOutput": [
...
def test_authorization_scaffold_includes_comments_for_unsupported_midpoint_authorizations():
    code = build_authorization_scaffold(
        ApiType.REST,
        [
            {
