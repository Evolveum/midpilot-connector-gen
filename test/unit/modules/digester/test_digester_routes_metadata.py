...
"""Unit tests for the digester metadata routes and their job scheduling."""
...
async def test_extract_metadata_success():
    ...
    with (
        ...
        session_id = uuid4()
        response = await extract_metadata(session_id=session_id, skip_cache=True, db=MagicMock())
